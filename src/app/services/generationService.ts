...
export class generationService {
    public getPokemonByGeneration(generationNumbers: number[]): string[] {
        return this.generations
            .filter(g => generationNumbers.includes(g.generationNumber))
    ...
    private generations: generation[] = [
        ...
        new generation(4,
            ["TURTWIG", "GROTLE", "TORTERRA", "CHIMCHAR", "MONFERNO", "INFERNAPE",
                ...
                "BUDEW", "ROSE`RADE", "CRANIDOS", "RAMPARDOS", "SHIELDON", "BASTIODON",
                ...
                "BRONZOR", "BRONZONG", "BONSLY", "MIME_JR", "HAPPINY", "CHATOT",
                ...
                "GLISCOR", "MAMOSWINE", "PORYGON_Z", "GALLADE", "PROBOPASS", "DUSKNOIR",
        ...
        new generation(6,
            ["CHESPIN", "QUILLADIN", "CHESNAUGHT", "FENNEKIN", "BRAIXEN", "DELPHOX",
                "FROAKIE", "FROGADIER", "GRENINJA", "BUNNELBY", "DIGGERBY", "FLETCHLING",
        ...
        new generation(7,
            ["ROWLET", "DARTRIX", "DECIDUEYE", "LITTEN", "TORRACAT", "INCINEROAR",
                ...
                "WISHIWASHI", "MAREANIE", "TOXAPEX", "MUDSDALE", "DEWPIDER", "ARAQUANID",
                "FOURSQUARE", "SHIINOTIC", "SALANDIT", "SALAZZLE", "STUFFUL", "BEWEAR",
        ...
        new generation(8,
            ["GROOKEY", "THWACKEY", "RILLABOOM", "SCORBUNNY", "RABOOT", "CINDERACE",
                ...
                "CLUSTR", "HATENNA", "HATTREM", "HATTERENE", "IMPIDIMP", "MORGREM", "GRIMMSNARL",
        ...
        new generation(9,
            ["SPRIGATITO", "FLORAGATO", "MEOWSCARADA", "FUECOCO", "CROCALOR", "SKELEDIRGE",
                ...
                "MAUSHOLD", "FIDDOUGH", "DACHSBUN", "SMOLIV", "DOLLIV", "ARBOLIVA",
                ...
                "IRON LEAVES", "DIPPLIN", "ARCHALUDON", "HYDRAPPLE", "OGERPON", "FEZANDIPITI",
                "MUXTAPEO", "OKIDOGI", "GOROCHU", "TERAPAGOS"
            ])
    ];
}